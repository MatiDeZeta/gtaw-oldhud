...
const char* kDefaultFile =
    ...
    "# minimapbar, speedsign. Use\r\n"
    "# \"none\" to leave the current HUD alone (both HUDs then draw at once, which is useful for\r\n"
    "# lining things up). The last four are parts of the current HUD the old one had no\r\n"
    "# equivalent of at all: the weather bar, the staff duty badge, the minimap tab strip and\r\n"
